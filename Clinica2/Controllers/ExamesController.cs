...
namespace Clinica2.Controllers
{
    public class ExamesController : Controller
    {
        ...
        public ExamesController(Clinica2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Exame != null ? 
                          ...
                          Problem("Entity set 'Clinica2Context.Exame'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeExames,EspecialidadeId")] Exame exame)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeExames,EspecialidadeId")] Exame exame)
        {
            if (id != exame.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Clinica2Context.Exame'  is null.");
            }
            var exame = await _context.Exame.FindAsync(id);
            if (exame != null)
            {
