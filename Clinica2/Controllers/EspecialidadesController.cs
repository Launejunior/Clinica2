...
namespace Clinica2.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        public EspecialidadesController(Clinica2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Especialidade != null ? 
                          ...
                          Problem("Entity set 'Clinica2Context.Especialidade'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,MedicoId")] Especialidade especialidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MedicoId")] Especialidade especialidade)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Clinica2Context.Especialidade'  is null.");
            }
            var especialidade = await _context.Especialidade.FindAsync(id);
            if (especialidade != null)
            {
